...
function guardarResposta(evento) {
  ...
  idInputResposta = evento.target.value;

  const botaoEnviar = document.querySelector(".alternatiavas button")
...
function validarResposta(){
    ...
    if (pergunta  === 10){
        ...
        botaoEnviar.addEventListener("click", proximaPerguta)
    }
...
function adicionarEventoInputs(){
  ...
  const inputsResposta = querySelectorAll(".alternativas input");
